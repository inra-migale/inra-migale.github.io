...
description: |
  Analysis of the Chaillou et al. (2015) dataset with R. This vignette documents and reproduces the analyses performed with FROGSSTATS during the training "Analyse de données métagénomiques 16S" that took place on the 18-21 March 2019
author:
  - name: Équipe Migale 
